  ...
  bracketStructure.games
    ...
    .forEach(game => {
      ...
      tooltips[`${game.id}_winner`] = {
        ...
        leverageValue: Math.round(leverageWeightedEv * 10) / 10,
        ...
        opponentLeverageValue: opponentData ? Math.round((opponentData.dataWinPct * roundPoints * (1 - opponentData.publicPickPct)) * 10) / 10 : null,
